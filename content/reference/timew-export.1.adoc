...
Supply either a list of interval IDs (e.g. `@1 @2`), or optional filters (see link:../../reference/timew-ranges.1[**timew-ranges**(7)] and/or link:../../reference/timew-tags.1[**timew-tags**(1)])
